...
class User extends \Core\Model
{
	...
	/**
	 * Validate current property value, adding validation error messages to the errors array property
	 *
	 * @return void
	 */
	 ...
	 *
	 * @return mixed The user object or false if authenticate fails
	 */
	 ...
	 *
	 * @return mixed User object if found ans the token hasn't expired, null otherwise
	 */
	public static function findByPasswordReset($token)
	{
		$token = new Token($token);
		$hashed_token = $token->getValue();
		//$hashed_token = $token->getHash();
	...
	public function sendActivationEmail()
	{
		...
		$text = View::getTemplate('Password/activation_email.txt', ['url' => $url]);
	 ...
	 *
	 * @param array $date Data from the edit profile form
	 *
